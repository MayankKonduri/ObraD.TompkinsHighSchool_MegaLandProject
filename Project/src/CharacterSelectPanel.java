...
public class CharacterSelectPanel extends JPanel implements Serializable {
    ...
    public CharacterSelectPanel(JFrame frame, ClientMain clientMain, ServerMain serverMain, HostPanel hostPanel, ConnectPanel connectPanel, Boolean isHost, CardSelectPanel cardSelectPanel) {
        ...
        if(!isHost) {
            ...
            playerClient = new Player(clientMain.Final_gamePlayerNames_ClientSide.indexOf(connectPanel.nameTextField.getText()), connectPanel.nameTextField.getText(), false, 0, 0, 0, true, true, false, new ArrayList<BuildingCards>(), new ArrayList<TreasureCard>(), new ArrayList<LevelCard>(), null, new ArrayList<TreasureCard>(), new ArrayList<BuildingCards>());
